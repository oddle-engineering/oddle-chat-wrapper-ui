...
### Changed
- Merge pull request #9 from oddle-engineering/feature/generative-ui
- 1.0.55
- chore(build): rebuild dist for recent fixes
...
### Fixed
- remove unused padding in the thinking bubble

## [1.0.51] - 2026-04-27

### Fixed
- no padding for the chat-wrapper with message
...
### Changed
- revert: restore with-messages state padding to original layout
...
### Changed
- Refactor chat-wrapper CSS to remove unnecessary !important from main title font size
...
### Fixed
- adjust message sanitization logic
...
### Added
- add remark-breaks for improved markdown rendering
