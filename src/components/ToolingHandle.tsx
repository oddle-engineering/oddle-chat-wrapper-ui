...
interface ToolingHandleTriggerProps {
  title: string;
...
interface ToolingHandleContentProps {
  children: ReactNode;
}

export function ToolingHandle({ children }: ToolingHandleProps) {
  return <div className="chat-wrapper__tooling-handle">{children}</div>;
}

export function ToolingHandleTrigger({
  title,
  status = "processing",
  toolData,
  toolName,
  ...
  const getToolDescription = () => {
    if (!toolName || !clientTools) return null;
      ...
      case "processing":
        return (
          <div className="chat-wrapper__tooling-handle-trigger-content">
            ...
            <div className="chat-wrapper__status-group">
              <div className="chat-wrapper__thinking-icon">
                <div className="chat-wrapper__thinking-icon">
                  <svg
                    width="16"
      ...
      case "error":
        return (
          <div className="chat-wrapper__tooling-handle-trigger-content">
            ...
            <span className="chat-wrapper__tooling-handle-title">{title}</span>
          </div>
        );
      default:
        return (
          <div className="chat-wrapper__tooling-handle-trigger-content">
            ...
            <span>{`AI text input${toolName ? ` <${toolName}>` : ""}`}...</span>
            <div className="chat-wrapper__thinking-icon">
              <div className="chat-wrapper__thinking-icon">
                <svg
                  width="16"
  ...
  return (
    <div className="chat-wrapper__tooling-handle-trigger">
      {renderContent()}
    </div>
  );
}
